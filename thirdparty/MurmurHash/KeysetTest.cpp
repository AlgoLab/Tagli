...
bool
VerificationTest (pfHash hash, const int hashbits, uint32_t expected,
		  bool verbose)
{
...
bool
SanityTest (pfHash hash, const int hashbits)
{
...
void
AppendedZeroesTest (pfHash hash, const int hashbits)
{
...
void
TwoBytesKeygen (int maxlen, KeyCallback & c)
{
  //----------
  // Compute # of keys
...
DumpCollisionMap (CollisionMap < hashtype, ByteVec > &cmap)
{
