...
void
printbits (const void *blob, int len)
{
...
void
printbits2 (const uint8_t * k, int nbytes)
{
  printf ("[");
...
void
printhex32 (const void *blob, int len)
{
  assert ((len & 3) == 0);
...
void
printbytes (const void *blob, int len)
{
...
void
printbytes2 (const void *blob, int len)
{
  uint8_t *d = (uint8_t *) blob;
...
uint32_t
getbit (const void *block, int len, uint32_t bit)
{
...
uint32_t
getbit_wrap (const void *block, int len, uint32_t bit)
{
  uint8_t *b = (uint8_t *) block;
...
void
setbit (void *block, int len, uint32_t bit)
{
  uint8_t *b = (uint8_t *) block;
...
void
setbit (void *block, int len, uint32_t bit, uint32_t val)
{
  val ? setbit (block, len, bit) : clearbit (block, len, bit);
}

void
clearbit (void *block, int len, uint32_t bit)
{
  uint8_t *b = (uint8_t *) block;
...
void
lshift1 (void *blob, int len, int c)
{
  int nbits = len * 8;
...
void
lshift8 (void *blob, int nbytes, int c)
{
...
void
lshift32 (void *blob, int len, int c)
{
  assert ((len & 3) == 0);
...
void
rshift1 (void *blob, int len, int c)
{
  int nbits = len * 8;
...
void
rshift8 (void *blob, int nbytes, int c)
{
  uint8_t *k = (uint8_t *) blob;
...
void
rshift32 (void *blob, int len, int c)
{
  assert ((len & 3) == 0);
...
void
lrot32 (void *blob, int len, int c)
{
  assert ((len & 3) == 0);
...
void
rrot32 (void *blob, int len, int c)
{
  assert ((len & 3) == 0);
...
uint32_t
window1 (void *blob, int len, int start, int count)
{
  int nbits = len * 8;
  start %= nbits;
...
uint32_t
window8 (void *blob, int len, int start, int count)
{
  int nbits = len * 8;
  start %= nbits;
...
uint32_t
window32 (void *blob, int len, int start, int count)
{
  int nbits = len * 8;
  start %= nbits;
